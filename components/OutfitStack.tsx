...
const OutfitStack: React.FC<OutfitStackProps> = ({ outfitHistory, onRemoveLastGarment }) => {
  return (
    <div className="flex flex-col">
      <h2 className="text-xl font-serif tracking-wider text-gray-800 dark:text-gray-200 border-b border-gray-400/50 dark:border-gray-500/50 pb-2 mb-3">Outfit Stack</h2>
          ...
          >
            ...
            {index > 0 && index === outfitHistory.length - 1 && (
               <button
                ...
                className="flex-shrink-0 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors p-2 rounded-md hover:bg-red-50 dark:hover:bg-red-900/30"
